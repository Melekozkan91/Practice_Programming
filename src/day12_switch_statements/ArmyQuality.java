...
/*
Declare and assign these variables: Citizenship(boolean), resident (boolean), and has high school diploma (boolean),
 ...
 */
 public static void main(String[] args) {
    ...
    // I need to get the value/info/answer from user and assign to hasCitizinShip
    hasCitizenship= input.nextBoolean();
    System.out.println("\nAre you a resident? (true/false)");

    isResident =input.nextBoolean();
    System.out.println("\nDo you have the high school diploma(true/false) ");
